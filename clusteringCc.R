### preamble
rm(list = ls())
wd = "~/Google Drev/ComputerClass"
dd = "~/Google Drev/ComputerClass/Data"
setwd(wd)
...
## k-means evaluation via bootstrapping and cluster stability ~ Jaccard similarity
...
gcAgNe <- agnes(gcdist, diss = TRUE,method = "average")
plot(gcAgNe)
